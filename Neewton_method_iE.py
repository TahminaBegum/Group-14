...
if __name__ == '__main__':
    ...
    counter = 0
    k=1.5
    bound2, step_initial_estimator = initial_estimator(f, bound1, counter,k)
    ...
    print("The total steps in with initial estimator with Newton method bidirectional:= ",
          step_newton_method_bidirectional + step_initial_estimator)
